...
const SeatSelection = () => {
  ...
  // 👉 Move to payment (no booking yet)
    ...
    <>
      ...
      <style>{`
        ...
        .seat.selected {
          background: #f5c518;
          color: #000;
          box-shadow: 0 0 15px rgba(245,197,24,.9);
        }
      ...
      <div className="wrapper">
          ...
          <div className="row" key={row}>
            ...
            {groupedSeats[row].map((seat, index) => (
              <React.Fragment key={seat.seatId}>
                {index === Math.floor(groupedSeats[row].length / 2) && (
                ...
                <div
                  ...
                  onClick={() => toggleSeat(seat.seatId, seat.isBooked)}
                >
                  {seat.number}
                </div>
              </React.Fragment>
        ...
        <div className="legend">
          <span>
            <div className="box" style={{ background: "#2ecc71" }}></div>
            Available
          </span>
          <span>
            <div className="box" style={{ background: "#f5c518" }}></div>
            Selected
          </span>
          <span>
            <div className="box" style={{ background: "#e50914" }}></div>
            Booked
          </span>
        </div>
      </div>
